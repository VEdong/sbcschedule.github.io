...
function initEvent(event) {
  ...
  // const eventRunnoElement = eventElement.querySelector("[data-event-runno]");
  // const eventSpecimenElement = eventElement.querySelector("[data-event-specimen]");
  // const eventsMethodElement = eventElement.querySelector("[data-event-method]");
  // const eventsAssignElement = eventElement.querySelector("[data-event-assign]");
  ...
  // eventRunnoElement.textContent = event.runno;
  // eventSpecimenElement.textContent = event.specimen;
  // eventsMethodElement.textContent = event.method;
  // eventsAssignElement.textContent = event.assign;
