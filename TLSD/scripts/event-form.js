...
function fillFormWithEvent(formElement, event) {
  ...
  const dateInputElement = formElement.querySelector("#date");
  // const runnoInputElement = formElement.querySelector("#runno");
  // const specimenInputElement = formElement.querySelector("#specimen");
  // const methodInputElement = formElement.querySelector("#method");
  // const assignInputElement = formElement.querySelector("#assign");
  const startTimeSelectElement = formElement.querySelector("#start-time");
  const endTimeSelectElement = formElement.querySelector("#end-time");
  ...
  // runnoInputElement.value = event.runno;
  // specimenInputElement.value = event.specimen;
  // methodInputElement.value = event.method;
  // assignInputElement.value = event.assign;
...
function formIntoEvent(formElement) {
  ...
  // const runno = formData.get("runno");
